...
date: 2023-08-21
categories: [FarmOS, Ubuntu, Self Hosting, Git, map tiles, satellite imagery, ArcGIS, REST]
---
...
After this is done, install the add-on as you otherwise would. `git clone` the repository into your FarmOS folder and activate it via the web interface. If you need tips on how to do this, check out my previous post on [how to add a FarmOS module to your home server](blog/2023/06_06_farmos_modules.qmd).